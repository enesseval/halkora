...
export const en: Dictionary = {
  ...
  detail: {
    ...
    leaveClosesTitle: 'The ring will close',
    leaveClosesBody: "You're the only one here, so leaving closes the ring. The history and stats stay, but nobody can check in again.",
    leaveCloses: 'Close and leave',
  ...
  shareCard: {
    ...
    joinClosed: "Joining is closed — we're under way",
