...
export const tr = {
  ...
  detail: {
    ...
    leaveClosesTitle: 'Halka kapanacak',
    leaveClosesBody: 'Halkada senden başka kimse yok, o yüzden ayrılmak halkayı kapatır. Geçmiş ve istatistikler kalır, ama artık check-in yapılamaz.',
    leaveCloses: 'Kapat ve ayrıl',
  ...
  shareCard: {
    ...
    joinClosed: 'Katılım kapandı — devam ediyoruz',
