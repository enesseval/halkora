...
export const tr = {
  ...
  settings: {
    ...
    usernameCharInvalid: 'Geçersiz karakter var. Yalnızca küçük harf, rakam ve alt çizgi kullanılabilir.',
    usernameTooShort: 'En az 3 karakter olmalı.',
  ...
  join: {
    ...
    ringClosedTitle: 'Bu halka kapandı.',
    ringClosedSubtitle: (title: string) => `${title} artık devam etmiyor. Davet bağlantısı geçerli değil.`,
    alreadyInTitle: 'Bu halkada zaten varsın.',
    alreadyInSubtitle: (title: string) => `${title} halkasının üyesisin. Tekrar katılmana gerek yok.`,
    goToRing: 'Halkaya git',
